...
function TraceJourney() {
  ...
  /** Open the browser's native print dialog for the completed result. */
    ...
    <div className="mx-auto w-full max-w-3xl px-5 py-9 sm:px-8 sm:py-12">
      ...
      {diagnosis ? (
        <div className="print-surface">
          ...
          <section aria-labelledby="trace-heading" className="print-section mt-12">
            <p className="m-0 text-sm font-black uppercase tracking-[0.12em] text-primary">
          ...
          <section
            ...
            className={`print-section mt-10 border-t-8 px-5 py-7 sm:px-7 ${
          ...
          <ActionInstructions diagnosis={diagnosis} />

          <div className="print-hidden mt-10 flex flex-col gap-3 sm:flex-row">
            <button
              className="min-h-tap w-full bg-primary px-5 py-3 text-lg font-black text-paper hover:bg-ink sm:w-auto"
              onClick={printResult}
              type="button"
            >
              Print this page
          ...
          <p className="print-footer">
            Generated by Paisa Kahan Hai — an independent hackathon prototype.
